...
NEGATIVE_TRAIN = r'C:\Users\ASUS\OneDrive\Documents\Facial Images\Nondiabetics'
...
def process(img, filters):
    ...
    for kern in filters:
        ...
        cv2.imshow('Filtered Image', fimg)  # Display filtered image
...
if __name__ == '__main__':
    ...
    create_csv_output(r"C:\Users\ASUS\OneDrive\Documents\Facial Images\featureVectors.csv", NEGATIVE_TRAIN)